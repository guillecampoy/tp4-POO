...
public class CreacionEmpleadoSimple implements Ejecutable {
    @Override
    public void execute() {
        UtilsColor.imprimirBloque(ContextColor.INFO, "Se procede a creación de empleado simple:");
        ...
        Empleado empleado = new Empleado(nombreEmpleado, puestoEmpleado);
